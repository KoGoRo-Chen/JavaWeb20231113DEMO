<!-- 原碼位置: C:\Users\kogor\Desktop\商研院JAVA課程\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\JavaWeb20231113DEMO\org\apache\jsp\WEB_002dINF\view\guestbook -->
<%@page import="java.util.Set"%>
<%@page import="java.util.stream.Collectors"%>
<%@page import="java.util.Map"%>
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="java.util.Date"%>
<%@page import="servlet.guestbook.model.Guestbook"%>
...
<% 
	...
	/*
	使用 Java 8 的 Stream API 对访客列表进行统计，得到男性和女性的数量，并按年龄分组统计
	*/
	...
	Map<Integer, Long> ageMap = guestbooks.stream().collect(Collectors.groupingBy(Guestbook::getAge, Collectors.counting()));
out.print(ageMap);
	/*
	输出年龄统计的结果。
	這行程式碼使用了 Java 8 的 Stream API 中的 collect 方法，
	以及 Collectors.groupingBy 和 Collectors.counting 收集器，
	來對 guestbooks 列表按照 Guestbook 物件的年齡進行分組統計。
	*/
%>
